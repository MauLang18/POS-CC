        ...
        try
        {
            ...
            for (int i = 1; i <= installmentCount; i++)
            {
                var invoice = new Entity.Invoice
                {
                    ...
                    IssueDate = DateTime.SpecifyKind(DateTime.Parse(request.IssueDate.ToString()), DateTimeKind.Utc),
                    PaymentDate = DateTime.SpecifyKind(DateTime.Parse(request.PaymentDate.ToString()), DateTimeKind.Utc),
